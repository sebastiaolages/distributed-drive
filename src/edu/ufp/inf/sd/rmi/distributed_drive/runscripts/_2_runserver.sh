...
# * java.rmi.server.hostname property specifies the SMTP_HOST_ADDR name or address to put in the stubs for remote objects exported in this Java virtual machine.
...
# To remove SecurityManager warnings add: -Djava.security.manager=allow
