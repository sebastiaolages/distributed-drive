...
%JDK%\bin\java -cp %CLASSPATH%;%JAVAPROJ%\src\edu\ufp\inf\sd\rabbitmq\rabbitmq\lib\amqp-client-5.9.0.jar;%JAVAPROJ%\src\edu\ufp\inf\sd\rabbitmq\rabbitmq\lib\slf4j-api-1.7.30.jar;%JAVAPROJ%\src\edu\ufp\inf\sd\rabbitmq\rabbitmq\lib\slf4j-simple-1.7.30.jar ^
